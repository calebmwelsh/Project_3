...
class Prompt_3():
    ...
    def render(self):
        ...
        if schedule_obj.intro[5]:
            ...
            font_1_gold.render('Task Duration',task_obj.page_surf,(int(task_obj.page_surf.get_width() * .47 ),int(task_obj.page_surf.get_height() * .29 )))
            font_1_gold.render('(In Minutes)',task_obj.page_surf,(int(task_obj.page_surf.get_width() * .47 ),int(task_obj.page_surf.get_height() * .36 )))
