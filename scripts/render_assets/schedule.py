...
class Schedule():
    ...
    def init_obj(self):
        ...
        self.user_day_of_week = self.day_type.days_data[self.tday.weekday()].day
    ...
    def render(self):
        ...
        if self.day_idx != self.user_day_idx:
            ...
            if self.day_type.days_data[self.user_day_idx].data == []:
                ...
                pre_len = 0
                for i, event in enumerate(self.day_type.days_data[self.user_day_idx].data):
                    ...
                    # render text
                    font_1_black.render(event[2],self.app.window.display,(int(self.app.window.display.get_width() * .008 + pre_len),int(self.app.window.display.get_height() * .4 )))
